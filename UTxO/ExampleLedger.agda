...
dummyValidator : State → DATA → Bool
dummyValidator _ _ = true

mkValidator : TxOutputRef → (State → DATA → Bool)
mkValidator tin _ (LIST (I (ℤ.pos n) ∷ I (ℤ.pos n') ∷ [])) = (id tin ≡ᵇ n) ∧ (index tin ≡ᵇ n')
mkValidator tin _ _                                        = false
